...
DEM50 = GRIDobj('C:\Users\Omri\Desktop\University\MSc\Fieldwork\Site27\DEM\site27_DEM_50cm.tif');
...
ST50_2 = load('C:\Users\Omri\Desktop\University\MSc\Matlab\DEM_Chi_analysis\STREAMobjs\ST50_2_27.mat');
ST50_2 = ST50_2.ST50_2;

% extract cliff network and higland network
ST50_cl = klargestconncomps(ST50_2,1); % assuming the relevant channels are among the longest 3
ST50_hl = modify(ST50_2,'rmnodes',ST50_hl);
