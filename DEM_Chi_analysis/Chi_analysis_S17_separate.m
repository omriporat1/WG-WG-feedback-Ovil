...
DEM50 = GRIDobj('C:\Users\Omri\Desktop\University\MSc\Fieldwork\Site17\DEM\site17_DEM_50cm.tif');
...
ST50_2 = load('C:\Users\Omri\Desktop\University\MSc\Matlab\DEM_Chi_analysis\STREAMobjs\ST50_2_17.mat');
...
%     set(gca,'Color',[0.9 0.9 0.9])
    ...
    text(min(xlim), max(ylim), sprintf('Weighted mean STD, highland = %0.2f', mean_std_all_bins_hl(i)), 'Horiz','left', 'Vert','top', 'Color',[0, 0.4470, 0.7410], 'FontWeight', 'Bold');
    text(min(xlim), max(ylim), sprintf('Weighted mean STD, cliff = %0.2f', mean_std_all_bins_cl(i)), 'Horiz','left', 'Vert','bottom', 'Color',[0.9290, 0.6940, 0.1250], 'FontWeight', 'Bold');
end
